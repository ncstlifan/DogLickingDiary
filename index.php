		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Header -->
                   ...
                   <button class="btn btn-primary btn-filled btn-xs" onclick="randomSentence()">再来一则</button>
						<nav>
					</header>

				<!-- Footer -->
					<footer id="footer">
						<p class="copyright">©李凡版权所有<a target="_black" href='https://ncst.eu.org/'>李凡发布</a></p>
					</footer>
